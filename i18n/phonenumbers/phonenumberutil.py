...
PHONE_NUMBER_FORMAT_E164 = 0
PHONE_NUMBER_FORMAT_INTERNATIONAL = 1
PHONE_NUMBER_FORMAT_NATIONAL = 2

PHONE_NUMBER_TYPE_FIXED_LINE = 0
PHONE_NUMBER_TYPE_MOBILE = 1
# In some countries (e.g. the USA), it is impossible to distinguish between
# fixed-line and mobile numbers by looking at the phone number itself.
PHONE_NUMBER_TYPE_FIXED_LINE_OR_MOBILE = 2
# Freephone lines
PHONE_NUMBER_TYPE_TOLL_FREE = 3
PHONE_NUMBER_TYPE_PREMIUM_RATE = 4
# The cost of this call is shared between the caller and the recipient, and
# is hence typically less than PREMIUM_RATE calls. See
# http:#en.wikipedia.org/wiki/Shared_Cost_Service for more information.
PHONE_NUMBER_TYPE_SHARED_COST = 5
# Voice over IP numbers. This includes TSoIP (Telephony Service over IP).
PHONE_NUMBER_TYPE_VOIP = 6
# A personal number is associated with a particular person, and may be routed
# to either a MOBILE or FIXED_LINE number. Some more information can be found
# here: http:#en.wikipedia.org/wiki/Personal_Numbers
PHONE_NUMBER_TYPE_PERSONAL_NUMBER = 7
PHONE_NUMBER_TYPE_PAGER = 8
# A phone number is of type UNKNOWN when it does not fit any of the known
# patterns for a specific country.
PHONE_NUMBER_TYPE_UNKNOWN = 9
...
def get_length_of_geographical_area_code(number):
    ...
    if (type_ != PHONE_NUMBER_TYPE_FIXED_LINE and
        type_ != PHONE_NUMBER_TYPE_FIXED_LINE_OR_MOBILE):
        return 0
...
# /**
# # Gets the length of the national destination code (NDC) from the Phone_number
...
#  *
# # phone_util = get_instance()
# # number = phone_util.parse('18002530000', 'US')
...
# #           phone_util.get_length_of_national_destination_code(number)
# # if national_destination_code_length > 0:
# #       national_destination_code =
# #               national_significant_number.substring(0, national_destination_code_length)
# #       subscriber_number =
# #               national_significant_number.substring(national_destination_code_length)
# # else:
# #       national_destination_code = ''
# #       subscriber_number = national_significant_number
# # 
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the Phone_number object for
# #           which clients want to know the length of the NDC.
# # @return:number} the length of NDC of the Phone_number object passed in.
#  */
# def get_length_of_national_destination_code
#         function(number):

#     /** @type:i18n.phonenumbers.Phone_number} */
#     copied_proto
...
#         # extension here.
#         copied_proto = new i18n.phonenumbers.Phone_number()
...
#             i18n.phonenumbers.Phone_number_format.INTERNATIONAL)
#     /** @type:!Array.<string>} */
#     number_groups = national_significant_number.split(
#             _NON_DIGITS_PATTERN)
...
#     if number_groups[0].length == 0:
#         number_groups.shift()
    
#     if number_groups.length <= 2:
#         return 0
    

#     if (self.get_region_code_for_number(number) == 'AR' &&
#             self.get_number_type(number) == i18n.phonenumbers.Phone_number_type.MOBILE):
...
#         return number_groups[2].length + 1
    
#     return number_groups[1].length
...
#  *
# # @param:?string} region_code the ISO 3166-1 two-letter country code that
# #           denotes the country/region that we want to get the country code for.
# # @return:boolean} true if region code is valid.
# # @private
#  */
# def _is_valid_region_code
#         function(region_code):

#     return region_code != null &&
#             region_code.to_upper_case() in i18n.phonenumbers.metadata.country_to_metadata
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the phone number to be
# #           formatted.
# # @param:i18n.phonenumbers.Phone_number_format} number_format the format the
# #           phone number should be formatted into.
# # @return:string} the formatted phone number.
#  */
# def format
#         function(number, number_format):

#     /** @type:number} */
#     country_code = number.get_country_code_or_default()
#     /** @type:string} */
#     national_significant_number = i18n.phonenumbers.Phone_number_util
#             .get_national_significant_number(number)
#     if number_format == i18n.phonenumbers.Phone_number_format.E164:
#         # Early exit for E164 case since no formatting of the national number needs
#         # to be applied. Extensions are not formatted.
#         return self._format_number_by_format(country_code,
#                                                                             i18n.phonenumbers.Phone_number_format.E164,
#                                                                             national_significant_number, '')
...
#             self._format_national_number(national_significant_number,
#                                                                  region_code,
#                                                                  number_format)
#     return self._format_number_by_format(country_code,
#                                                                         number_format,
...
# # @param:i18n.phonenumbers.Phone_number_format} number_format the format the
# #           phone number should be formatted into.
# # @param:Array.<i18n.phonenumbers.Number_format>} user_defined_formats formatting
# #           rules specified by clients.
# # @return:string} the formatted phone number.
#  */
# def format_by_pattern
#         function(number, number_format, user_defined_formats):
...
#     /** @type:number} */
#     size = user_defined_formats.length
#     for (var i = 0 i < size ++i):
#         /** @type:i18n.phonenumbers.Number_format} */
#         num_format = user_defined_formats[i]
#         /** @type:string} */
#         national_prefix_formatting_rule =
#                 num_format.get_national_prefix_formatting_rule_or_default()
#         if national_prefix_formatting_rule.length > 0:
...
#             # prefix.
#             /** type:i18n.phonenumbers.Number_format} */
#             num_format_copy = new i18n.phonenumbers.Number_format()
#             num_format_copy.merge_from(num_format)
#             /** @type:string} */
#             national_prefix =
#                     self.get_metadata_for_region(region_code).get_national_prefix_or_default()
#             if national_prefix.length > 0:
#                 # Replace $NP with national prefix and $FG with the first group ($1).
#                 national_prefix_formatting_rule = national_prefix_formatting_rule
#                         .replace(_NP_PATTERN,
#                                          national_prefix)
#                         .replace(_FG_PATTERN, '$1')
...
#             user_defined_formats_copy.push(num_format_copy)
#         else:
#             # Otherwise, we just add the original rule to the modified list of
#             # formats.
#             user_defined_formats_copy.push(num_format)
...
#     /** @type:string} */
#     formatted_national_number =
#             self._format_according_to_formats(national_significant_number,
#                                                                          user_defined_formats_copy,
#                                                                          number_format)
#     return self._format_number_by_format(country_code,
#                                                                         number_format,
...
# /**
# # @param:i18n.phonenumbers.Phone_number} number
# # @param:string} carrier_code
# # @return:string
#  */
# prototype.
#         format_national_number_with_carrier_code = function(number, carrier_code):
...
#             self._format_national_number(national_significant_number,
#                                                                  region_code,
#                                                                  i18n.phonenumbers.Phone_number_format.NATIONAL,
#                                                                  carrier_code)
#     return self._format_number_by_format(
#             country_code, i18n.phonenumbers.Phone_number_format.NATIONAL,
...
# # country_calling_from is supplied, we format the number in its INTERNATIONAL
# # format. If the country_calling_from is the same as the country where the number
...
# # @param:i18n.phonenumbers.Phone_number} number the phone number to be
# #           formatted.
# # @param:string} country_calling_from the ISO 3166-1 two-letter country code
# #           that denotes the foreign country where the call is being placed.
# # @return:string} the formatted phone number.
#  */
# def format_out_of_country_calling_number
#         function(number, country_calling_from):
...
#         if self.is_nANPACountry(country_calling_from):
#             # For NANPA countries, return the national format for these countries but
#             # prefix it with the country code.
#             return country_code + ' ' +
#                     self.format(number, i18n.phonenumbers.Phone_number_format.NATIONAL)
        
#     } else if country_code == self.get_country_code_for_region(country_calling_from):
...
#     /** @type:string} */
#     formatted_national_number =
#             self._format_national_number(national_significant_number, region_code,
#                     i18n.phonenumbers.Phone_number_format.INTERNATIONAL)
...
#     } else if metadata.has_preferred_international_prefix():
#         international_prefix_for_formatting =
#                 metadata.get_preferred_international_prefix_or_default()
    

#     return international_prefix_for_formatting != '' ?
#             international_prefix_for_formatting + ' ' + country_code + ' ' +
#                     formatted_national_number + formatted_extension :
#             self._format_number_by_format(
#                     country_code, i18n.phonenumbers.Phone_number_format.INTERNATIONAL,
#                     formatted_national_number, formatted_extension)
...
# # field of the Phone_number object passed in. If such information is missing,
# # the number will be formatted into the NATIONAL format by default.
#  *
# # @param:i18n.phonenumbers.Phone_number} number the Phone_number that needs to
# #           be formatted in its original number format.
# # @param:string} country_calling_from the country whose IDD needs to be prefixed
# #           if the original number has one.
# # @return:string} the formatted phone number in its original number format.
#  */
# def format_in_original_format
#         function(number, country_calling_from):

#     if not number.has_country_code_source():
#         return self.format(number, i18n.phonenumbers.Phone_number_format.NATIONAL)
    
#     switch (number.get_country_code_source()):
#         case i18n.phonenumbers.Phone_number.Country_code_source
#                 .FROM_NUMBER_WITH_PLUS_SIGN:
#             return self.format(number,
#                     i18n.phonenumbers.Phone_number_format.INTERNATIONAL)
#         case i18n.phonenumbers.Phone_number.Country_code_source.FROM_NUMBER_WITH_IDD:
#             return self.format_out_of_country_calling_number(number, country_calling_from)
#         case i18n.phonenumbers.Phone_number.Country_code_source
#                 .FROM_NUMBER_WITHOUT_PLUS_SIGN:
#             return self.format(number,
#                     i18n.phonenumbers.Phone_number_format.INTERNATIONAL).substring(1)
#         case i18n.phonenumbers.Phone_number.Country_code_source.FROM_DEFAULT_COUNTRY:
#         default:
#             return self.format(number, i18n.phonenumbers.Phone_number_format.NATIONAL)
...
# # @return:string} the national significant number of the Phone_number object
# #           passed in.
#  */
...
#     # numbers.
#     /** @type:string} */
#     national_number = '' + number.get_national_number()
#     if (number.has_italian_leading_zero() && number.get_italian_leading_zero() &&
#             is_leading_zero_country(
#                     number.get_country_code_or_default())):
...
#  *
# # @param:number} country_code the country calling code.
# # @param:i18n.phonenumbers.Phone_number_format} number_format the format the
# #           phone number should be formatted into.
# # @param:string} formatted_national_number
# # @param:string} formatted_extension
# # @return:string} the formatted phone number.
# # @private
#  */
# def _format_number_by_format
#         function(country_code, number_format,
#                          formatted_national_number, formatted_extension):

#     switch (number_format):
#         case i18n.phonenumbers.Phone_number_format.E164:
#             return PLUS_SIGN + country_code +
#                     formatted_national_number + formatted_extension
#         case i18n.phonenumbers.Phone_number_format.INTERNATIONAL:
#             return PLUS_SIGN + country_code + ' ' +
#                     formatted_national_number + formatted_extension
#         case i18n.phonenumbers.Phone_number_format.NATIONAL:
#         default:
...
# # @param:string} region_code the ISO 3166-1 two-letter country code.
# # @param:i18n.phonenumbers.Phone_number_format} number_format the format the
# #           phone number should be formatted into.
# # @param:string=} opt_carrier_code
# # @return:string} the formatted phone number.
# # @private
#  */
...
#                     number_format == i18n.phonenumbers.Phone_number_format.NATIONAL) ?
#             metadata.number_format_array() : metadata.intl_number_format_array()
#     return self._format_according_to_formats(number, available_formats, number_format,
#                                                                                 opt_carrier_code)
...
#  *
# # @param:string} national_number a string of characters representing a phone
# #           number.
# # @param:Array.<i18n.phonenumbers.Number_format>} available_formats the
...
#                 national_prefix_formatting_rule =
#                         num_format.get_national_prefix_formatting_rule_or_default()
#                 if (number_format == i18n.phonenumbers.Phone_number_format.NATIONAL &&
...
# # @return:i18n.phonenumbers.Phone_number} a valid fixed-line number for the
...
#     return self.get_example_number_for_type(region_code,
#             i18n.phonenumbers.Phone_number_type.FIXED_LINE)
...
# # @param:string} region_code the ISO 3166-1 two-letter country code that
# #           denotes the country for which an example number is needed.
# # @param:i18n.phonenumbers.Phone_number_type} type the type of number that is
# #           needed.
# # @return:i18n.phonenumbers.Phone_number} a valid number for the specified
...
#     /** @type:i18n.phonenumbers.Phone_number_desc} */
#     desc = self._get_number_desc_by_type(
#             self.get_metadata_for_region(region_code), type)
#     try:
#         if desc.has_example_number():
#             return self.parse(desc.get_example_number_or_default(), region_code)
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the Phone_number that might have
# #           an extension.
# # @param:string} region_code the ISO 3166-1 two-letter country code.
...
#         return ''
#     else:
#         return self._format_extension(number.get_extension_or_default(), region_code)
...
#  *
# # @param:string} extension_digits the extension digits.
# # @param:string} region_code the ISO 3166-1 two-letter country code.
...
# /**
# # @param:i18n.phonenumbers.Phone_metadata} metadata
# # @param:i18n.phonenumbers.Phone_number_type} type
# # @return:i18n.phonenumbers.Phone_number_desc
# # @private
#  */
...
#     switch (type):
#         case i18n.phonenumbers.Phone_number_type.PREMIUM_RATE:
#             return metadata.get_premium_rate()
#         case i18n.phonenumbers.Phone_number_type.TOLL_FREE:
#             return metadata.get_toll_free()
#         case i18n.phonenumbers.Phone_number_type.MOBILE:
#             return metadata.get_mobile()
#         case i18n.phonenumbers.Phone_number_type.FIXED_LINE:
#         case i18n.phonenumbers.Phone_number_type.FIXED_LINE_OR_MOBILE:
#             return metadata.get_fixed_line()
#         case i18n.phonenumbers.Phone_number_type.SHARED_COST:
#             return metadata.get_shared_cost()
#         case i18n.phonenumbers.Phone_number_type.VOIP:
#             return metadata.get_voip()
#         case i18n.phonenumbers.Phone_number_type.PERSONAL_NUMBER:
#             return metadata.get_personal_number()
#         case i18n.phonenumbers.Phone_number_type.PAGER:
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the phone number that we want
# #           to know the type.
# # @return:i18n.phonenumbers.Phone_number_type} the type of the phone number.
#  */
# def get_number_type
#         function(number):

#     /** @type:string} */
#     region_code = /** @type:string} */ (self.get_region_code_for_number(number))
#     if not self._is_valid_region_code(region_code):
#         return i18n.phonenumbers.Phone_number_type.UNKNOWN
    
#     /** @type:string} */
#     national_significant_number =
#             get_national_significant_number(number)
#     return self._get_number_type_helper(national_significant_number,
...
# # @param:i18n.phonenumbers.Phone_metadata} metadata
# # @return:i18n.phonenumbers.Phone_number_type
# # @private
#  */
...
#     if self._is_number_matching_desc(national_number, metadata.get_premium_rate()):
#         return i18n.phonenumbers.Phone_number_type.PREMIUM_RATE
    
#     if self._is_number_matching_desc(national_number, metadata.get_toll_free()):
#         return i18n.phonenumbers.Phone_number_type.TOLL_FREE
    
#     if self._is_number_matching_desc(national_number, metadata.get_shared_cost()):
#         return i18n.phonenumbers.Phone_number_type.SHARED_COST
    
#     if self._is_number_matching_desc(national_number, metadata.get_voip()):
#         return i18n.phonenumbers.Phone_number_type.VOIP
    
#     if (self._is_number_matching_desc(national_number,
#                                                                  metadata.get_personal_number())):
#         return i18n.phonenumbers.Phone_number_type.PERSONAL_NUMBER
    
#     if (self._is_number_matching_desc(national_number,
#                                                                  metadata.get_pager())):
#         return i18n.phonenumbers.Phone_number_type.PAGER
    

#     /** @type:boolean} */
#     is_fixed_line = self._is_number_matching_desc(national_number, metadata
#             .get_fixed_line())
#     if is_fixed_line:
#         if metadata.get_same_mobile_and_fixed_line_pattern():
#             return i18n.phonenumbers.Phone_number_type.FIXED_LINE_OR_MOBILE
#         } else if (self._is_number_matching_desc(national_number,
#                                                                                     metadata.get_mobile())):
#             return i18n.phonenumbers.Phone_number_type.FIXED_LINE_OR_MOBILE
        
#         return i18n.phonenumbers.Phone_number_type.FIXED_LINE
    
#     # Otherwise, test to see if the number is mobile. Only do this if certain
#     # that the patterns for mobile and fixed line aren't the same.
#     if (not metadata.get_same_mobile_and_fixed_line_pattern() &&
#             self._is_number_matching_desc(national_number, metadata.get_mobile())):
#         return i18n.phonenumbers.Phone_number_type.MOBILE
...
# # @return:i18n.phonenumbers.Phone_metadata
#  */
# def get_metadata_for_region
#         function(region_code):

#     if region_code == null:
#         return null
    
#     region_code = region_code.to_upper_case()
#     /** @type:i18n.phonenumbers.Phone_metadata} */
#     metadata = self.country_to_metadata[region_code]
#     if metadata == null:
#         /** @type:goog.proto2.Pb_lite_serializer} */
#         serializer = new goog.proto2.Pb_lite_serializer()
#         /** @type:Array} */
#         metadata_serialized =
#                 i18n.phonenumbers.metadata.country_to_metadata[region_code]
#         if metadata_serialized == null:
#             return null
        
#         metadata = /** @type:i18n.phonenumbers.Phone_metadata} */ (
#                 serializer.deserialize(i18n.phonenumbers.Phone_metadata.get_descriptor(),
#                         metadata_serialized))
#         self.country_to_metadata[region_code] = metadata
...
# /**
# # @param:string} national_number
# # @param:i18n.phonenumbers.Phone_number_desc} number_desc
# # @return:boolean
# # @private
#  */
...
#     /** @type:string} */
#     region_code = /** @type:string} */ (self.get_region_code_for_number(number))
#     return self._is_valid_region_code(region_code) &&
...
#     # For countries where we don't have metadata for Phone_number_desc, we treat
...
#             i18n.phonenumbers.Phone_number_type.UNKNOWN
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the phone number whose origin
# #           we want to know.
# # @return:?string} the country/region where the phone number is from, or None
# #           if no country matches this calling code.
#  */
# def get_region_code_for_number
#         function(number):
...
# /**
# # @param:i18n.phonenumbers.Phone_number} number
# # @param:Array.<string>} region_codes
# # @return:?string
# # @private
#  */
# prototype.
#         _get_region_code_for_number_from_region_list = function(number, region_codes):
...
#     region_code
#     /** @type:number} */
#     region_codes_length = region_codes.length
#     for (var i = 0 i < region_codes_length i++):
#         region_code = region_codes[i]
#         # If leading_digits is present, use self. Otherwise, do full validation.
#         /** @type:i18n.phonenumbers.Phone_metadata} */
#         metadata = self.get_metadata_for_region(region_code)
...
#         } else if (self._get_number_type_helper(national_number, metadata) !=
#                 i18n.phonenumbers.Phone_number_type.UNKNOWN):
#             return region_code
...
# # @param:boolean} strip_non_digits true to strip non-digits from the national
# #           dialling prefix.
...
#  *
# # @param:i18n.phonenumbers.Phone_number} number the number that needs to be
# #           checked.
...
#     return self.is_possible_number_with_reason(number) ==
...
#             get_national_significant_number(number)
#     /** @type:i18n.phonenumbers.Phone_number_desc} */
#     general_num_desc = self.get_metadata_for_region(region_code).get_general_desc()
...
# # is_possible_number(Phone_number number) with the resultant Phone_number object.
#  *
# # @param:string} number the number that needs to be checked, in the form of a
# #           string.
# # @param:string} country_dialing_from the ISO 3166-1 two-letter country code
...
#     try:
#         return self.is_possible_number(self.parse(number, country_dialing_from))
#     } catch (e):
#         return false
...
# # valid, and resets the Phone_number object passed in to that valid version. If
# # no valid number could be extracted, the Phone_number object passed in will not
# # be modified.
# # @param:i18n.phonenumbers.Phone_number} number a Phone_number object which
...
#     /** @type:i18n.phonenumbers.Phone_number} */
#     number_copy = new i18n.phonenumbers.Phone_number()
...
#     } while (not self.is_valid_number(number_copy))
...
#  *
# # @param:!goog.string.String_buffer} full_number
# # @param:!goog.string.String_buffer} national_number
# # @return:number
#  */
...
# # @param:i18n.phonenumbers.Phone_metadata} default_region_metadata metadata
# #           about the region this number may be from.
# # @param:!goog.string.String_buffer} national_number a string buffer to store
...
# # @param:boolean} store_country_code_source true if the country_code_source field
# #           of phone_number should be populated.
# # @param:i18n.phonenumbers.Phone_number} phone_number the Phone_number object
...
#     /** @type:i18n.phonenumbers.Phone_number.Country_code_source} */
#     country_code_source = self.maybe_strip_international_prefix_and_normalize(
...
#             i18n.phonenumbers.Phone_number.Country_code_source.FROM_DEFAULT_COUNTRY):
#         if (full_number.get_length() <
#                 _MIN_LENGTH_FOR_NSN):
#             throw i18n.phonenumbers.Error.TOO_SHORT_AFTER_IDD
        
#         /** @type:number} */
#         potential_country_code = self.extract_country_code(full_number,
#                                                                                                              national_number)
...
#                 self.maybe_strip_national_prefix(potential_national_number,
...
#                                 i18n.phonenumbers.Phone_number.Country_code_source
#                                         .FROM_NUMBER_WITHOUT_PLUS_SIGN)
...
#  *
# # @param:Reg_exp} idd_pattern the regular expression for the international
# #           prefix.
# # @param:!goog.string.String_buffer} number the phone number that we wish to
...
# # prefix was present.
#  *
# # @param:!goog.string.String_buffer} number the non-normalized telephone number
# #           that we wish to strip any international dialing prefix from.
# # @param:string} possible_idd_prefix the international direct dialing prefix
# #           from the country we think this number may be dialed in.
# # @return:i18n.phonenumbers.Phone_number.Country_code_source} the corresponding
...
#         return i18n.phonenumbers.Phone_number.Country_code_source.FROM_DEFAULT_COUNTRY
...
#         return i18n.phonenumbers.Phone_number.Country_code_source
#                 .FROM_NUMBER_WITH_PLUS_SIGN
    
#     # Attempt to parse the first digits as an international prefix.
#     /** @type:Reg_exp} */
#     idd_pattern = new Reg_exp(possible_idd_prefix)
#     if self._parse_prefix_as_idd(idd_pattern, number):
#         _normalize_sB(number)
#         return i18n.phonenumbers.Phone_number.Country_code_source.FROM_NUMBER_WITH_IDD
...
#     _normalize_sB(number)
#     return self._parse_prefix_as_idd(idd_pattern, number) ?
#             i18n.phonenumbers.Phone_number.Country_code_source.FROM_NUMBER_WITH_IDD :
#             i18n.phonenumbers.Phone_number.Country_code_source.FROM_DEFAULT_COUNTRY
...
#  *
# # @param:!goog.string.String_buffer} number the normalized telephone number
# #           that we wish to strip any national dialing prefix from.
# # @param:?string} possible_national_prefix a regex that represents the national
# #           direct dialing prefix from the country we think this number may be dialed
# #           in.
# # @param:?string} transform_rule the string that specifies how number should be
# #           transformed according to the regex specified in possible_national_prefix.
# # @param:Reg_exp} national_number_rule a regular expression that specifies what a
...
# # @param:string} number_to_parse number that we are attempting to parse.
# # @param:?string} default_country the ISO 3166-1 two-letter country code that
...
#     return self._is_valid_region_code(default_country) ||
...
#  *
# # @param:string} number_to_parse number that we are attempting to parse. This
...
# #           supplied.
# # @return:i18n.phonenumbers.Phone_number} a phone number proto buffer filled
...
#                                                                                                                          default_country):
#     return self._parse_helper(number_to_parse, default_country, false, true)
...
#     if not self._is_valid_region_code(default_country):
#         if (number_to_parse.length > 0 && number_to_parse.char_at(0) !=
#                 PLUS_SIGN):
#             throw i18n.phonenumbers.Error.INVALID_COUNTRY_CODE
        
    
#     return self._parse_helper(number_to_parse, default_country, true, true)
...
# #           format. The country code for the number in this case would be stored as
# #           that of the default country supplied.
# # @param:boolean} keep_raw_input whether to populate the raw_input field of the
# #           phone_number with number_to_parse.
# # @param:boolean} check_region should be set to false if it is permitted for
...
#     if check_region && not self._check_region_for_parsing(number, default_country):
#         throw i18n.phonenumbers.Error.INVALID_COUNTRY_CODE
    

#     /** @type:i18n.phonenumbers.Phone_number} */
#     phone_number = new i18n.phonenumbers.Phone_number()
#     if keep_raw_input:
...
#     /** @type:string} */
#     extension = self.maybe_strip_extension(national_number)
#     if extension.length > 0:
#         phone_number.set_extension(extension)
    

#     /** @type:i18n.phonenumbers.Phone_metadata} */
#     country_metadata = self.get_metadata_for_region(default_country)
...
#     /** @type:number} */
#     country_code = self.maybe_extract_country_code(national_number.to_string(),
#             country_metadata, normalized_national_number, keep_raw_input, phone_number)
#     if country_code != 0:
#         /** @type:string} */
#         phone_number_region = self.get_region_code_for_country_code(country_code)
...
#         self.maybe_strip_national_prefix(normalized_national_number, country_metadata
...
#  *
# # @param:i18n.phonenumbers.Phone_number|string} first_number_in first number to
# #           compare. If it is a string it can contain formatting, and can have
# #           country code specified with + at the start.
# # @param:i18n.phonenumbers.Phone_number|string} second_number_in second number to
# #           compare. If it is a string it can contain formatting, and can have
# #           country code specified with + at the start.
...
#         first_number = self._parse_helper(first_number_in, None, false, false)
#     else:
#         first_number = new i18n.phonenumbers.Phone_number()
#         first_number.merge_from(first_number_in)
    
#     if typeof second_number_in == 'string':
#         second_number = self._parse_helper(second_number_in, None, false, false)
#     else:
#         second_number = new i18n.phonenumbers.Phone_number()
#         second_number.merge_from(second_number_in)
    
#     # First clear raw_input and country_code_source field and any empty-string
#     # extensions so that
#     # we can use the Phone_number.exactly_same_as() method.
...
#                 self._is_national_number_suffix_of_the_other(first_number, second_number)):
...
#     if self._is_national_number_suffix_of_the_other(first_number, second_number):
#         return Match_type.SHORT_NSN_MATCH
...
# # the same.
#  *
# # @param:i18n.phonenumbers.Phone_number} first_number the first Phone_number
# #           object.
# # @param:i18n.phonenumbers.Phone_number} second_number the second Phone_number
# #           object.
# # @return:boolean} true if one Phone_number is the suffix of the other one.
# # @private
#  */
...
# # expression.
#  *
# # @param:Reg_exp|string} regex the regular expression to match against.
...
# /**
# # @param:i18n.phonenumbers.Phone_number} other
# # @return:boolean
#  */
# i18n.phonenumbers.Phone_number.def exactly_same_as function(other):
#     return other != None &&
#             self.get_country_code() == other.get_country_code() &&
#             self.get_national_number() == other.get_national_number() &&
#             self.get_extension() == other.get_extension() &&
#             self.get_italian_leading_zero() == other.get_italian_leading_zero() &&
#             self.get_raw_input() == other.get_raw_input() &&
#             self.get_country_code_source() == other.get_country_code_source()



# /**
# # @param:i18n.phonenumbers.Phone_number_desc} other
# # @return:boolean
#  */
# i18n.phonenumbers.Phone_number_desc.def exactly_same_as function(other):
#     return other != None &&
#             self.get_national_number_pattern() == other.get_national_number_pattern() &&
#             self.get_possible_number_pattern() == other.get_possible_number_pattern() &&
#             self.get_example_number() == other.get_example_number()



# /**
# # @param:i18n.phonenumbers.Phone_number} other
# # @return:i18n.phonenumbers.Phone_number
# # @suppress:access_controls
#  */
# i18n.phonenumbers.Phone_number.def merge_from function(other):
#     if other:
#         self._values = goog.clone_object(other._values)
...
# /**
# # @param:i18n.phonenumbers.Number_format} other
