...
#
#    intl_number_format_elements = element.findall("intlNumberFormat")
#    for intl_number_format_element in intl_number_format_elements:
#        format = phonemetadata_pb2.NumberFormat()
#        _set_leading_digits_patterns(number_format_element, format)
#        format.pattern = _validate_re(number_format_element.attrib["pattern"])
#        format_pattern = number_format_element.findall("format")
...
#        else:
#            format.domestic_carrier_code_formatting_rule = carrier_code_formatting_rule
#        metadata.intl_number_format.add().format = format
#
    general_desc = phonemetadata_pb2.PhoneNumberDesc()
    general_desc = _process_phone_number_desc_element(general_desc, element, "generalDesc")
#    metadata.set_general_desc(general_desc)
#    metadata.set_fixed_line(process_phone_number_desc_element(general_desc, element, "fixedLine"))
#    metadata.set_mobile(process_phone_number_desc_element(general_desc, element, "mobile"))
#    metadata.set_toll_free(process_phone_number_desc_element(general_desc, element, "tollFree"))
#    metadata.set_premium_rate(process_phone_number_desc_element(general_desc, element, "premiumRate"))
#    metadata.set_shared_cost(process_phone_number_desc_element(general_desc, element, "sharedCost"))
#    metadata.set_voip(process_phone_number_desc_element(general_desc, element, "voip"))
#    metadata.set_personal_number(process_phone_number_desc_element(general_desc, element, "personal_number"))
...
def _get_domestic_carrier_code_formatting_rule_from_element(element, national_prefix):
...
def _process_phone_number_desc_element(general_desc, country_element, number_type):
    ...
    definition. For example, if no "toll_free" element exists, we assume there
